  ...
  return (
    <View style={styles.container}>
      <PhoneMockup>
        ...
        <AnimatedRing x={leftRingPos.x} y={leftRingPos.y} visible={true} size={RING_SIZE} borderWidth={RING_BORDER_WIDTH} pulseDuration={RING_PULSE_DURATION} />
        <AnimatedRing x={rightRingPos.x} y={rightRingPos.y} visible={true} size={RING_SIZE} borderWidth={RING_BORDER_WIDTH} pulseDuration={RING_PULSE_DURATION} />
        {/* Hands on top (zIndex 2) */}
        <AnimatedFinger source={fingerWhite} style={leftHandStyle} from={-300} to={0} visible={true} />
        <AnimatedFinger source={fingerBlack} style={rightHandStyle} from={300} to={0} visible={true} />
      </PhoneMockup>
    </View>
  );
};
...
export default StepFingerPlacement; 